...
@php
    ...
    |--------------------------------------------------------------------------
    |
    | Sumber data ini sama dengan yang digunakan pada dewan-redaksi.
    | Urutan member di sini menjadi sumber nomor 01, 02, 03, dst.
    |
    */
    ...
    <div class="bd-team-shell">
        ...
        >
            ...
            <main class="bd-profile-main">
                ...
                {{-- =================================================
                     NOMOR URUT MEMBER
                     OTOMATIS MENGIKUTI DEWAN-REDAKSI
                ================================================== --}}
