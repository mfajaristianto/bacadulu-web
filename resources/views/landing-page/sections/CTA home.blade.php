                ...
                <div class="bd-activity-eyebrow">
                    <span class="bd-activity-eyebrow-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8 2v3M16 2v3M4 9h16M5 4h14a1 1 0 011 1v15H4V5a1 1 0 011-1z"/>
                        </svg>
                    </span>
        ...
        <div class="bd-publish-card">
            ...
            <div class="bd-publish-action">
                ...
                <p>
                    ...
                    Tim kami akan membantu menentukan proses yang paling sesuai untuk naskah Anda.
                </p>
...
.bd-activity-card{
    ...
    color:inherit;
    text-align:left;
    box-shadow:0 14px 32px rgba(33,25,78,.08);
    cursor:pointer;
}

.bd-activity-card.is-active{
    border-color:rgba(239,88,67,.18);
    box-shadow:0 20px 44px rgba(33,25,78,.13);
}
...
.bd-activity-detail{
    display:none;
    grid-template-columns:76px minmax(0,1fr) 215px;
    align-items:center;
    gap:23px;
    padding:18px;
    overflow:hidden;
    ...
    box-shadow:0 10px 30px rgba(33,25,78,.04);
}

.bd-activity-detail.is-active{
    display:grid;
}
...
/* TOUCH INFORMATION */
html[data-baca-input="touch"] .bd-activity-stage{
    height:auto;
    overflow:hidden;
    perspective:none;
    touch-action:pan-y;
...
html[data-baca-input="touch"] .bd-activity-card{
    position:relative;
    left:auto;
    top:auto;
    width:min(100%,320px);
...
html[data-baca-input="touch"] .bd-activity-card:not(.is-active){
    display:none!important;
}

html[data-baca-input="touch"] .bd-activity-card.is-active{
    display:flex!important;
}

/* PHONE INFORMATION */
html[data-baca-device="phone"] .bd-activity-section{
    padding:56px 0 54px;
}

html[data-baca-device="phone"] .bd-activity-container{
    width:100%;
    padding:0 16px;
}

html[data-baca-device="phone"] .bd-activity-header{
    flex-direction:column;
    align-items:flex-start;
    gap:15px;
}

html[data-baca-device="phone"] .bd-activity-heading h2{
    font-size:32px;
}

html[data-baca-device="phone"] .bd-activity-heading p{
    font-size:9.5px;
}

html[data-baca-device="phone"] .bd-activity-header-action{
    width:100%;
    justify-content:space-between;
}

html[data-baca-device="phone"] .bd-activity-total{
    align-items:flex-start;
    padding:0;
    border:0;
}

html[data-baca-device="phone"] .bd-activity-header-line{
    margin:19px 0;
}

html[data-baca-device="phone"] .bd-activity-card{
    width:min(100%,295px);
    height:355px;
}

html[data-baca-device="phone"] .bd-activity-card-media{
    height:215px;
}

html[data-baca-device="phone"] .bd-activity-controls{
    width:min(100%,295px);
    margin-top:12px;
}

html[data-baca-device="phone"] .bd-activity-nav{
    width:45px;
    height:45px;
}

html[data-baca-device="phone"] .bd-activity-details{
    width:100%;
    margin-top:22px;
}

html[data-baca-device="phone"] .bd-activity-detail{
    grid-template-columns:1fr;
    gap:10px;
    padding:14px;
}

html[data-baca-device="phone"] .bd-activity-detail-index{
    width:max-content;
    min-width:64px;
    min-height:36px;
    flex-direction:row;
...
html[data-baca-device="phone"] .bd-activity-detail-index span{
    font-size:16px;
}

html[data-baca-device="phone"] .bd-activity-detail-top{
    display:block;
    margin-bottom:6px;
}

html[data-baca-device="phone"] .bd-activity-detail-active{
    display:none;
}

html[data-baca-device="phone"] .bd-activity-detail-main h3{
    max-width:100%;
    overflow:visible;
    font-size:18px;
    line-height:1.22;
...
html[data-baca-device="phone"] .bd-activity-detail-description{
    max-width:100%;
    font-size:9px;
    -webkit-line-clamp:2;
}

html[data-baca-device="phone"] .bd-activity-detail-action{
    width:100%;
    padding:10px 0 0;
    border-left:0;
    border-top:1px solid rgba(33,25,78,.08);
...
html[data-baca-device="phone"] .bd-activity-detail-action-label{
    display:none;
}

html[data-baca-device="phone"] .bd-activity-detail-action>a{
    width:100%;
    font-size:9.5px;
}

html[data-baca-device="phone"] .bd-activity-footer{
    width:100%;
    flex-direction:column;
    align-items:flex-start;
    gap:10px;
...
.bd-publish-card{
    ...
    background:
        ...
        linear-gradient(135deg,#21194E,#251D58);
    box-shadow:0 25px 60px rgba(33,25,78,.15);
}
...
/* CTA TOUCH */
html[data-baca-input="touch"] .bd-publish-section{
    padding-bottom:58px;
}

html[data-baca-input="touch"] .bd-publish-container{
    width:100%;
    padding:0 20px;
}

html[data-baca-input="touch"] .bd-publish-card{
    grid-template-columns:1fr;
    gap:24px;
    min-height:0;
    padding:29px 21px;
...
html[data-baca-input="touch"] .bd-publish-copy,
html[data-baca-input="touch"] .bd-publish-services,
html[data-baca-input="touch"] .bd-publish-action{
    grid-column:1;
    grid-row:auto;
}
...
html[data-baca-input="touch"] .bd-publish-service{
    min-height:100px;
    display:flex;
    flex-direction:column;
    align-items:flex-start;
...
html[data-baca-input="touch"] .bd-publish-service-progress{
    left:13px;
    right:13px;
}
...
html[data-baca-input="touch"] .bd-publish-watermark,
html[data-baca-input="touch"] .bd-publish-glow{
    display:none;
}

/* PHONE CTA */
html[data-baca-device="phone"] .bd-publish-container{
    padding:0 16px;
}

html[data-baca-device="phone"] .bd-publish-copy h2{
    font-size:31px;
}

html[data-baca-device="phone"] .bd-publish-copy p{
    font-size:9px;
}

html[data-baca-device="phone"] .bd-publish-action h3{
    font-size:19px;
}
...
@media(max-width:390px){
    ...
    html[data-baca-device="phone"] .bd-publish-card{
        padding:26px 17px;
    }
    ...
    html[data-baca-device="phone"] .bd-publish-services{
        grid-template-columns:1fr;
    }
}
</style>
