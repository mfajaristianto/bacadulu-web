<section id="home" class="bd-hero relative w-full min-h-[610px] flex items-center overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        ...
        <div class="absolute inset-0 z-[2] bg-gradient-to-r from-black/80 via-black/60 to-black/25"></div>
        <div class="absolute inset-0 z-[3] bd-hero-grid"></div>
        <div class="bd-hero-glow absolute -right-32 top-16 z-[3] w-[400px] h-[400px] rounded-full bg-orange-500/20 blur-[120px] pointer-events-none"></div>
    </div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full grid grid-cols-1 lg:grid-cols-12 gap-8 xl:gap-12 items-center">
        ...
        <div class="lg:col-span-7 text-white" data-bd-reveal="left">
            <div class="inline-flex items-center gap-2 px-4 py-2 mb-5 rounded-full bg-white/10 backdrop-blur-md border border-white/15">
            ...
            <h1 class="bd-hero-title font-black text-white">
                Wujudkan Karya Ilmiah
                <span class="text-[#FFC145]">Berkualitas</span>
                dan Berdampak
            </h1>
        ...
        <div class="hidden lg:flex lg:col-span-5 justify-center items-center" data-bd-reveal="right" data-bd-delay="150">
            <div class="bd-hero-visual relative" data-bd-tilt>
...
.bd-hero-glow{animation:bdGlowFloat 7s ease-in-out infinite}
