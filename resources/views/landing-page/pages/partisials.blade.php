<article class="book-card">
    ...
    <div class="cover-area">
        <div class="book-3d">
            <div class="book-face book-spine" style="background:linear-gradient(135deg,#EF5843,#F7AA35);"></div>
            <div class="book-face book-pages"></div>

            @if($book->cover)
                <div class="book-face book-front" style="background-image:url('{{ asset('storage/'.$book->cover) }}');"></div>
            @else
                <div class="book-face book-front" style="background:linear-gradient(135deg,#EF5843,#F7AA35);">
                    <div>
                        <div class="cover-title">{{ \Illuminate\Support\Str::limit($book->title,45) }}</div>
    ...
    {{-- INFO --}}
    <div class="book-info">
        <div class="book-publisher">{{ $book->publisher ?: 'Baca Dulu' }}</div>
        ...
        <a href="{{ route('portofolio.bookstore.show',['book'=>$book->slug]) }}" class="detail-btn">
            Lihat Deskripsi
        </a>
    </div>
</article>