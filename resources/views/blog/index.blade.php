...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
        ...
        <aside class="lg:col-span-1 lg:sticky lg:top-24 lg:self-start lg:max-h-[calc(100vh-7rem)] lg:overflow-y-auto">
            ...
            <div class="pr-1">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                    ...
                    {{-- TOMBOL TULIS ARTIKEL DIPINDAH KE SINI --}}
                    @auth
                        <hr class="my-4 border-gray-100">
                        <a
        ...
        <main class="lg:col-span-2 min-w-0">
            ...
            {{-- Bagian tombol Tulis Artikel di atas feed utama sudah dihapus --}}
                    ...
                    <article class="bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md transition">
                        ...
                        <div class="mt-4 flex items-center gap-6 pt-4 border-t border-slate-100 text-slate-500 text-sm">
                            ...
                            <button
                                ...
                                class="flex items-center gap-2 hover:text-orange-500 transition {{ $post->isLikedBy(auth()->id()) ? 'text-orange-500' : '' }}"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="{{ $post->isLikedBy(auth()->id()) ? 'currentColor' : 'none' }}" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            {{-- COMMENT --}}
                            <a href="{{ route('blog.show', $post->slug) }}#comments" class="flex items-center gap-2 hover:text-orange-500 transition">
                            ...
                            {{-- SHARE --}}
                            <button onclick="sharePost('{{ addslashes($post->title) }}', '{{ route('blog.show', $post->slug) }}')" class="flex items-center gap-2 hover:text-orange-500 transition">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M8.684 13.342a3 3 0 100 2.316m0-2.316a3 3 0 100 2.316m9.632-8.658a3 3 0 11-6 0 3 3 0 016 0zm0 12a3 3 0 11-6 0 3 3 0 016 0zm-9.632-6a3 3 0 10-6 0 3 3 0 006 0z" />
                                </svg>
                                Share
                            </button>
                ...
                <div class="bg-white rounded-xl border border-gray-100 p-5">
                    ...
                    <div class="space-y-4">
                        ...
                        @forelse($posts->take(5) as $index => $post)
                            ...
                            <a href="{{ route('blog.show', $post->slug) }}" class="flex gap-3 group min-w-0">
