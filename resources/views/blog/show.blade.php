...
<div class="max-w-4xl mx-auto px-6 py-10">
    ...
    <a
        ...
        class="inline-flex items-center gap-1.5 text-sm font-semibold text-slate-500 hover:text-orange-700 transition mb-5 group"
    >
        <svg
    ...
    <article class="bg-white p-6 md:p-8 rounded-2xl border border-gray-100 shadow-sm">
        ...
        {{-- KATEGORI --}}
        <span class="inline-block text-xs font-semibold text-orange-700 bg-orange-50 border border-orange-100 px-3 py-1 rounded-full mb-4">
            {{ $post->category }}
        </span>
                ...
                @if(auth()->id() === $post->user_id)
                    ...
                    <div class="flex items-center gap-2 shrink-0">
                        ...
                        <a
                            ...
                            class="p-2 border border-gray-200 rounded-lg text-slate-500 hover:bg-orange-50 hover:border-orange-200 hover:text-orange-700 transition"
                            title="Edit artikel"
                        >
                            <svg
                                class="w-4 h-4"
        ...
        <div class="mt-8 pt-4 border-t border-gray-100 flex items-center gap-4">
            ...
            @auth
                ...
                <button
                    ...
                    {{ $isLiked
                        ...
                        : 'bg-white border-gray-200 text-slate-600 hover:bg-orange-50 hover:border-orange-200 hover:text-orange-600' }}"
                >
                    <svg
                        id="like-icon"
                        class="w-5 h-5"
                    ...
                    <span
                        id="like-count"
                        class="text-sm font-bold bg-orange-100/60 px-2 py-0.5 rounded-full"
                    >
                        {{ $post->likes()->count() }}
                    </span>
                </button>
            ...
            @else
                ...
                <a
                    href="{{ route('login') }}"
                    class="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-gray-200 bg-white text-slate-600 hover:bg-orange-50 hover:border-orange-200 hover:text-orange-600 transition"
                >
                    <svg
                        class="w-5 h-5"
                        fill="none"
                    ...
                    <span class="text-sm font-bold bg-gray-100 px-2 py-0.5 rounded-full">
                        {{ $post->likes()->count() }}
                    </span>
                </a>
        ...
        @auth
            ...
            >
                ...
                <div class="mt-3 flex justify-end">
                    ...
                    <button
                        type="submit"
                        class="px-5 py-2 bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold rounded-lg transition"
                    >
                        Kirim Komentar
                    </button>
        ...
        <div class="mt-5 space-y-3">
            ...
            @forelse($post->comments as $comment)
                ...
                <div class="bg-white p-4 rounded-xl border border-gray-100 flex gap-3">
                    ...
                    <div class="w-8 h-8 rounded-full bg-orange-500 text-white flex items-center justify-center text-xs font-bold shrink-0">
...
function toggleLike(slug) {
    ...
    .then(data => {
        ...
        if (data.liked) {
            ...
            btn.className =
                "inline-flex items-center gap-2 px-4 py-2 rounded-xl border transition bg-orange-50 border-orange-200 text-orange-600";
            ...
            btn.className =
                "inline-flex items-center gap-2 px-4 py-2 rounded-xl border transition bg-white border-gray-200 text-slate-600 hover:bg-orange-50 hover:border-orange-200 hover:text-orange-600";
    ...
    .catch(err => {
        ...
        alert(
            'Terjadi kesalahan, pastikan Anda sudah login.'
        );
