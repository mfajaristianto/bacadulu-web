...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($jurnals as $jurnal)
            <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-xl flex flex-col justify-between">
                <div>
