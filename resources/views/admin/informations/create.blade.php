...
<div class="mx-auto max-w-5xl px-4 py-8">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-slate-500">
            Buat informasi baru untuk ditampilkan pada website Baca Dulu.
        </p>
    </div>
        ...
        <div class="space-y-6 p-6 md:p-7">
            ...
            <div>
                ...
                <p class="mt-2 text-xs leading-relaxed text-slate-400">
                    ...
                    Tanggal tidak lagi otomatis mengikuti waktu upload.
                </p>
            </div>
            ...
            <div>
                ...
                <p class="mt-2 text-xs leading-relaxed text-slate-400">
                    ...
                    Gambar portrait maupun landscape akan ditampilkan utuh tanpa dipotong paksa.
                </p>

                <div
                    id="imagePreviewWrap"
                    class="mt-4 hidden rounded-2xl border border-slate-200 bg-slate-50 p-3"
                >
                ...
                >
                    ...
                    <span>
                        ...
                        <span class="mt-1 block text-xs leading-relaxed text-slate-500">
                            Informasi ini akan ditampilkan pada bagian paling atas
                            halaman Baca Informasi. Jika sudah ada informasi yang
                            dipin, pin lama akan dilepas otomatis.
                        </span>
                    </span>
                </label>
