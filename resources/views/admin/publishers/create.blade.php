...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-6">Tambah Publisher</h1>

    <form method="POST" action="{{ route('admin.publishers.store') }}" enctype="multipart/form-data" class="space-y-4 rounded-xl border bg-white p-6 shadow-sm">
        @csrf
        <div>
        ...
        <div>
            @include('admin.partials.rich-text-editor', ['name' => 'about', 'label' => 'Tentang', 'value' => old('about')])
        </div>
        <div>
