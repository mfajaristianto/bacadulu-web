...
<body class="min-h-screen bg-slate-100 flex items-center justify-center px-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="text-center mb-8 entrance">
            ...
            <div class="logo-pulse inline-flex items-center justify-center
        ...
        {{-- LOGIN CARD --}}
        <div class="login-card bg-white rounded-2xl shadow-xl border border-slate-200 p-8 entrance entrance-delay-1 {{ $errors->any() || session('error') ? 'shake-error' : '' }}">
            ...
            >
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="input-field w-full pl-11 pr-11 py-3 rounded-xl
                                   border border-slate-300
                                   focus:border-orange-500
                                   focus:ring-2 focus:ring-orange-200
                                   outline-none"
                ...
                >
                    ...
                    <span class="btn-text">Masuk ke Admin</span>
                </button>
            ...
            {{-- SECURITY INFO --}}
            <div class="mt-6 pt-5 border-t border-slate-100 entrance entrance-delay-2">
        ...
        <p class="text-center text-xs text-slate-400 mt-6 entrance entrance-delay-3">
