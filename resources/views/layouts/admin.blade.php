...
<head>
    ...
    <style>
        ...
        .cms-logo-badge {
            ...
            box-shadow:
                0 6px 16px rgba(239, 88, 67, 0.35);
        }
        ...
        .cms-logout-btn {
            ...
            box-shadow:
                0 8px 18px rgba(239, 88, 67, 0.25);
        }
        ...
        .cms-logout-btn:hover {
            ...
            box-shadow:
                0 12px 22px rgba(239, 88, 67, 0.32);
        }
        ...
        .cms-btn-primary {
            ...
            box-shadow:
                0 6px 14px rgba(239, 88, 67, 0.25);
        }
        ...
        .cms-btn-primary:hover {
            ...
            box-shadow:
                0 10px 20px rgba(239, 88, 67, 0.3);
        }
...
<body class="min-h-screen bg-slate-100 text-slate-900">
    ...
    <div class="cms-sidebar-wrap min-h-screen flex">
        ...
        ========================================== --}}
        <aside
            class="cms-sidebar w-72 text-white p-6 hidden lg:block"
        >
            ...
            <nav class="space-y-1.5">
                ...
                >
                    ...
                    <button
                        type="submit"
                        class="cms-logout-btn w-full rounded-lg px-3 py-2.5 text-sm font-semibold text-white"
                    >
                        Logout
                    </button>
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            {{-- Mobile Topbar --}}
            <header
                class="cms-topbar lg:hidden sticky top-0 z-30 flex items-center justify-between px-5 py-4 border-b border-slate-200"
            >
                ...
                <label
                    for="cms-mobile-toggle"
                    class="cursor-pointer p-2 rounded-lg hover:bg-slate-100 transition-colors"
                >
